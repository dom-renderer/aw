...
Route::get('cart/status', [\App\Http\Controllers\FrontendController::class, 'cartStatus'])->name('cart.status');
Route::post('cart/merge', [\App\Http\Controllers\FrontendController::class, 'mergeCart'])->name('cart.merge');

Route::middleware(['auth:customer'])->group(function () {
    Route::post('cart/add', [\App\Http\Controllers\FrontendController::class, 'addToCart'])->name('cart.add');
    Route::put('cart/item/{id}', [\App\Http\Controllers\FrontendController::class, 'updateCartItemQuantity'])->name('cart.item.update');
    Route::delete('cart/item/{id}', [\App\Http\Controllers\FrontendController::class, 'removeFromCart'])->name('cart.item.remove');
